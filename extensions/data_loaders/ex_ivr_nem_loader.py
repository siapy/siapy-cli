...
Commands used to generate the results:
$ siapy-cli analysis train-model --model SavgolPLSXGB --data-loader IVRNemLoaderBinary --parameters ParamsSavgol --parameters ParamsPLS --parameters ParamsXGB --do-optimize
$ siapy-cli analysis train-model --model SavgolPLSXGB --data-loader IVRNemLoader --parameters ParamsSavgol --parameters ParamsPLS --parameters ParamsXGB --do-optimize
$ siapy-cli analysis generate-metrics --model SavgolPLSXGB --data-loader IVRNemLoaderBinary --do-optimize
$ siapy-cli analysis generate-metrics --model SavgolPLSXGB --data-loader IVRNemLoader --do-optimize
"""
